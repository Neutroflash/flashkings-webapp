  ...
  return (
    <div className="mx-auto flex max-w-sm flex-col gap-6 py-16">
      <div className="text-center">
        ...
        <p className="mt-1 text-xs uppercase tracking-widest text-zinc-500">Mi cuenta</p>
      </div>
      ...
      >
        ...
        <p className="text-center text-sm text-zinc-500">
          ...
          <Link href={`/cuenta/registro?redirect=${encodeURIComponent(redirectTo)}`} className="text-yellow-400 hover:underline">
            Regístrate
          </Link>
        </p>
      </form>
