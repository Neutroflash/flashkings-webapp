 ...
 *
 * Fondo blanco/texto negro fijo, independiente del tema oscuro del resto de la app — es un ticket
 * de papel térmico, no una pantalla; debe verse igual (y imprimirse limpio) sin importar en qué
 * tema esté el panel de administración que lo embebe.
 */
